  ...
  >
      ...
      <SwiperSlide>
        <div style={{textAlign:'center'}}>
          <img src={slide1.image} style={{width:'20%'}}/>
          <div style={{paddingBottom: '5%'}}>{slide1.title}</div>
        </div>
        </SwiperSlide>
      <SwiperSlide>
        <div style={{textAlign:'center'}}>
          <img src={slide2.image} style={{width:'20%'}}/>
          <div style={{paddingBottom: '5%'}}>{slide2.title}</div>
        </div>
        </SwiperSlide>
      <SwiperSlide>
        <div style={{textAlign:'center'}}>
          <img src={slide3.image} style={{width:'20%'}}/>
          <div style={{paddingBottom: '5%'}}>{slide3.title}</div>
        </div>
        </SwiperSlide>
      <SwiperSlide>
        <div style={{textAlign:'center'}}>
          <img src={slide4.image} style={{width:'20%'}}/>
          <div style={{paddingBottom: '5%'}}>{slide4.title}</div>
        </div>
        </SwiperSlide>
      <SwiperSlide>
        <div style={{textAlign:'center'}}>
          <img src={slide5.image} style={{width:'20%'}}/>
          <div style={{paddingBottom: '5%'}}>{slide5.title}</div>
        </div>
        </SwiperSlide>
    </Swiper>
    </div>
